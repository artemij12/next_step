...
#define pusk_pin 2 // установка пина на котором будет висеть кнопка Пуск/Стоп
#define  set_pin 3 // пин кнопки установки режима (номера пинов от балды написал)
#define  opt_pin 5 //пин, к которому подключается оптопара
struct save_data
{
float time;
u_int count_open;
